...
import { 
    ...
    Maximize, Lightbulb, Activity, Calendar
} from "lucide-react";
...
export default function FieldDetailPage() {
    ...
    const specifications = field?.specifications?.map(spec => ({
    ...
    const galleryImages = field
        ? (field.carousel_urls?.length > 0 ? field.carousel_urls : [field.image_url])
        : [];
                    ...
                    <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 animate-in fade-in slide-in-from-bottom-8 duration-700">
                        <div className="max-w-3xl">
                            ...
                            <div className="flex flex-wrap items-center gap-3 mb-4">
                                ...
                                <div className={`flex items-center text-[10px] font-bold px-3.5 py-1 rounded-full shadow-md border backdrop-blur-sm ${field.status === "available" ? "bg-green-500/20 text-green-300 border-green-500/30" : "bg-red-500/20 text-red-300 border-red-500/30"}`}>
                            ...
                            <div className="flex flex-wrap items-center gap-3 text-gray-200">
                                <div className="flex items-center gap-1.5 bg-black/40 backdrop-blur-md px-3.5 py-1.5 rounded-xl border border-white/10 shadow-md">
                                    ...
                                    <span className="font-bold text-white text-base leading-none">{field.rating}</span>
                                    <span className="text-xs text-gray-400 font-medium">/ 5.0</span>
                                </div>
                                <div className="flex items-center gap-1.5 bg-black/40 backdrop-blur-md px-3.5 py-1.5 rounded-xl border border-white/10 shadow-md">
                                    <MapPin className="w-4 h-4 text-[#E5C3A6]" />
                                    <span className="text-xs font-semibold text-gray-100">GOR UDINUS Semarang</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                    ...
                    <div className="xl:col-span-2 space-y-6">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 animate-in fade-in slide-in-from-bottom-10 duration-700 delay-100 fill-mode-both">
                            ...
                            <div className="bg-white p-4 rounded-xl border border-gray-200/60 shadow-sm flex flex-col items-center text-center justify-center hover:shadow-md hover:border-gray-300 transition-all cursor-default">
                                ...
                                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-0.5">Permukaan</p>
                                <p className="font-bold text-[#1B3627] text-sm capitalize">{field.surface_type}</p>
                            </div>
                            <div className="bg-white p-4 rounded-xl border border-gray-200/60 shadow-sm flex flex-col items-center text-center justify-center hover:shadow-md hover:border-gray-300 transition-all cursor-default">
                                <div className="w-10 h-10 rounded-xl bg-orange-50 flex items-center justify-center mb-3 text-orange-600">
                                    <Clock className="w-5 h-5" />
                                </div>
                                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-0.5">Jam Buka</p>
                                <p className="font-bold text-[#1B3627] text-sm">08:00 - 22:00</p>
                            </div>
                            <div className="bg-white p-4 rounded-xl border border-gray-200/60 shadow-sm flex flex-col items-center text-center justify-center hover:shadow-md hover:border-gray-300 transition-all cursor-default">
                                <div className="w-10 h-10 rounded-xl bg-purple-50 flex items-center justify-center mb-3 text-purple-600">
                                    <Calendar className="w-5 h-5" />
                                </div>
                                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mb-0.5">Jadwal Tersedia</p>
                        ...
                        <section className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200/60 shadow-sm animate-in fade-in slide-in-from-bottom-12 duration-700 delay-200 fill-mode-both relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-2.5 mb-4">
                                    ...
                                    <h3 className="text-xl sm:text-2xl font-bold text-[#1B3627] tracking-tight">Tentang Lapangan</h3>
                                </div>
                        ...
                        <section className="bg-white rounded-2xl p-6 sm:p-8 border border-gray-200/60 shadow-sm animate-in fade-in slide-in-from-bottom-12 duration-700 delay-300 fill-mode-both">
                            <div className="flex items-center gap-2.5 mb-6">
                                ...
                                <h3 className="text-xl sm:text-2xl font-bold text-[#1B3627] tracking-tight">Spesifikasi Lapangan</h3>
                            </div>
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {specifications.map((item, index) => (
                                    <div key={index} className="flex items-start gap-3.5 p-4 rounded-xl bg-gray-50/50 border border-gray-200/60 hover:bg-white hover:shadow-md hover:border-gray-300 transition-all group">
                                        ...
                                        <div className="flex flex-col">
                                            <span className="font-bold text-[#1B3627] text-sm">{item.label}</span>
                                            <span className="text-gray-500 text-xs mt-0.5">{item.subLabel}</span>
                                        </div>
                                    </div>
                                ))}
                            </div>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-8">
                                <div>
                                    <div className="flex items-center gap-2.5 mb-2">
                                        ...
                                        <h3 className="text-xl sm:text-2xl font-bold text-[#1B3627] tracking-tight">Ulasan Pemain</h3>
                                    </div>
                                    <p className="text-gray-500 font-medium ml-4 text-xs">Pendapat mereka yang sudah mencoba lapangan ini.</p>
                                </div>
                                <div className="bg-gray-50/50 px-4 py-3 rounded-xl border border-gray-200/60 flex flex-row sm:flex-col items-center sm:items-end gap-2 sm:gap-1">
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span className="text-2xl font-black text-[#1B3627] leading-none">{field.rating}</span>
                                    </div>
                                    <p className="text-[10px] text-gray-400 font-bold tracking-wide">124 Ulasan</p>
                                </div>
                            </div>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="p-5 rounded-xl bg-gray-50/50 border border-gray-200/60 hover:shadow-md transition-all">
                                    <div className="flex items-center gap-3.5 mb-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-[#1B3627] text-sm">Ahmad Reza</p>
                                    ...
                                    <p className="text-gray-600 text-xs leading-relaxed font-medium italic">"Kualitas lapangan sangat baik, pantulan bola sempurna dan fasilitas kamar mandinya sangat bersih. Sangat direkomendasikan!"</p>
                                </div>
                                {/* Review 2 */}
                                <div className="p-5 rounded-xl bg-gray-50/50 border border-gray-200/60 hover:shadow-md transition-all">
                                    <div className="flex items-center gap-3.5 mb-3">
                                        ...
                                        <div>
                                            <p className="font-bold text-[#1B3627] text-sm">Budi Wibowo</p>
                                            <div className="flex text-yellow-400 mt-0.5 gap-0.5">
                                                <Star className="w-3 h-3 fill-yellow-400" /><Star className="w-3 h-3 fill-yellow-400" /><Star className="w-3 h-3 fill-yellow-400" /><Star className="w-3 h-3 fill-yellow-400" /><Star className="w-3 h-3 text-gray-300 fill-gray-300" />
                                            </div>
                                        </div>
                                    </div>
                                    <p className="text-gray-600 text-xs leading-relaxed font-medium italic">"Cocok untuk latihan rutin. Hanya saja area parkir kadang penuh kalau akhir pekan. Pencahayaan malam hari sangat terang."</p>
                                </div>
                            </div>
                        </section>
                    ...
                    <div className="xl:col-span-1">
                        <div className="bg-white rounded-2xl p-6 border border-gray-200/60 shadow-md sticky top-28 animate-in fade-in slide-in-from-right-12 duration-700 delay-300 fill-mode-both z-30">
                                ...
                                {field.price_min ? (
                                    <div className="inline-flex flex-col items-center">
                                        <div className="flex items-start gap-1">
                                            <span className="text-lg font-bold text-[#1B3627] mt-1">Rp</span>
                                    ...
                                    <p className="text-lg font-bold text-gray-400 italic">Harga belum tersedia</p>
                                )}
                            ...
                            <div className="space-y-3 mb-6 bg-gray-50/50 p-4 rounded-xl border border-gray-200/60">
                                <div className="flex justify-between items-center py-1.5">
                                    <span className="text-gray-500 font-semibold text-xs">Buka Hari Ini</span>
                                    <span className="text-[#1B3627] font-extrabold text-xs">08:00 - 22:00</span>
                                </div>
                                <div className="w-full h-px bg-gray-200"></div>
                                <div className="flex justify-between items-center py-1.5">
                                    <span className="text-gray-500 font-semibold text-xs">Batas Reservasi</span>
                                    <span className="text-[#1B3627] font-extrabold text-xs">21:00 WIB</span>
                                </div>
                            </div>
